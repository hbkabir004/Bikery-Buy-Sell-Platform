...
const Banner = () => {
    return (
        <section>
            <div className="dark:bg-violet-400" style={{ backgroundImage: `url('https://images.wallpaperscraft.com/image/single/books_reading_tea_212048_1920x1080.jpg')`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
            ...
            <div className="carousel w-6/12 h-[450px] mx-auto mb-12 -mt-20 rounded-lg shadow-md lg:-mt-40">
