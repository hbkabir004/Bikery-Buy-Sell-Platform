...
const Registration = () => {
    ...
    const saveUser = (name, email) => {
        ...
        fetch(`https://server-rose.vercel.app/users`, {
            method: 'POST',
            headers: {
        ...
        <div className='flex justify-center items-center pt-8 mb-20'>
            <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900 dark:text-white dark:bg-gray-900'>
                ...
                <div className='flex items-center pt-4 space-x-1'>
                    ...
                    <p className='px-3 text-sm font-semibold dark:text-magenda-100'>
                ...
                <p className='px-6 text-sm text-center text-gray-400'>
                    ...
                    <Link to='/signin' className='hover:underline font-semibold text-magenda-100'>
                        Sign In
                    </Link>
                    .
                </p>
