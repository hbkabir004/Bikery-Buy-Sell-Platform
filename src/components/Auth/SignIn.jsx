            ...
            <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900 dark:text-white dark:bg-gray-900'>
                ...
                >
                    ...
                    <div>
                        <button
                            type='submit'
                            className='w-full px-8 py-3 font-semibold rounded-md bg-magenda-100 hover:bg-gray-700 hover:text-white text-gray-100'
                        >
                            Sign in
                        </button>
                    </div>
                ...
                <div className='space-y-1'>
                    <button
                        onClick={handleReset}
                        className='text-xs font-semibold hover:underline text-magenda-100'
                    >
                        Forgot password?
                    </button>
                </div>
                <div className='flex items-center pt-4 space-x-1'>
                    <div className='flex-1 h-px sm:w-16 dark:bg-magenda-100'></div>
                    <p className='font-semibold px-3 text-sm dark:text-magenda-100'>
                ...
                <p className='px-6 text-sm text-center text-gray-400'>
                    ...
                    <Link to='/signup' className='hover:underline font-semibold text-magenda-100'>
                        Sign up
                    </Link>
                    .
                </p>
